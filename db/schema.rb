...
ActiveRecord::Schema[8.0].define(version: 2026_04_01_075547) do
  ...
  create_table "inventory_items", force: :cascade do |t|
    ...
    t.index ["warehouse_id", "product_id"], name: "index_inventory_items_on_warehouse_id_and_product_id", unique: true
